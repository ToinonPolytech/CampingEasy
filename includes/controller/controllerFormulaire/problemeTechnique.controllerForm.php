...
if(isset($_SESSION['id']) && isset($_POST['timeCreated']) /*&& isset($_POST['timeEstimated'])*/ && isset($_POST['description'])
	&& isset($_POST['isBungalow']))
{
	...
	$pbTech = new PbTech(htmlspecialchars(NULL,$_SESSION['id'], $timeSecCreated, $timeSecEstimated, htmlspecialchars ($_POST['description']), htmlspecialchars($_POST['isBungalow'])));
