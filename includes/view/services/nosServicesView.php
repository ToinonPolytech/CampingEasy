	...
	<table class='table'>
		...
		{	
			...
			<tr> 
				...
				<?php 
				if($data['estReservable']==1 )// si état des lieux réservable => page de réservation de lieu ou dynamique avec champs pour la réservation 
				?>
						...
						<td><button type="button" class="btn btn-info btn-sm" name="reservLieu" onclick="loadToMain('<?php echo str_replace($_SERVER['DOCUMENT_ROOT'], '', i('lieuCommunView.php')); ?>', {id : <?php echo $data["id"]; ?>  }); return false;">Voir</button></td>
		...
		{	
			...
			<tr> 
				...
				<td><button type="button" class="btn btn-info btn-sm" name="voirrestau" onclick="loadToMain('<?php echo str_replace($_SERVER['DOCUMENT_ROOT'], '', i('restaurantView.php')); ?>', {id : <?php echo $data["id"]; ?>  }); return false;">Voir</button></td>
