...
<div class="col-lg-6" style="width:100%;" name="form-user" id="form-user">
	...
	<form role="form"  method="post" id="form_user" name="form_user">
		<div class="form-group">
			...
			<button class="btn btn-success" onclick="loadTo('<?php echo str_replace($_SERVER['DOCUMENT_ROOT'], '', i('subUser.controllerForm.php')); ?>',$('#form_user').serialize() , '#form_user', 'prepend'); return false;">Modifier</button>
		</div>
	</form>
</div>