	...
	<div class="col-lg-6" style="width:100%;" name="form-res" id="form-res">
		...
		<form role="form"  method="post" id="form_res" name="form_res">
			<div class="form-group">
				...
				<label for="timeStart">Nombre de couverts ?</label><br/>
				...
				<button type="button" class="btn btn-success" onclick="loadToMain('<?php echo str_replace($_SERVER['DOCUMENT_ROOT'], "", i("reserverRestau.php")); ?>', {date : $('#timeStart').val(), nbrPersonnes : $('#nbrPersonnes').val()}); return false;">Chercher</button>
			</div>
		</form>
	</div>
